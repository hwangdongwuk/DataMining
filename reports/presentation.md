...
| 소스 | 유형 | 건수 |
|------|------|-----------|
| 나라장터 입찰공고 (용역) | REST API | **420,104건** |
| 나라장터 첨부 PDF / HWP (샘플) | 파일 다운로드 | 197건 → 본문 173 |
| 네이버 뉴스 검색 API | REST API | **13,765건** |
| 금융위원회 RSS | RSS 2.0 | 30건 |

- 기간 **2023-01-01 ~ 2025-11-25** (27개월) · 수요기관 **16,551곳**
- Key-based Join: `bidNtceNo` (메타 ↔ 첨부 본문)
