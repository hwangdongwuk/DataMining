...
<div class="cards">
  <div class="card"><div class="n">33,860</div><div class="l">정제 공고</div></div>
  <div class="card"><div class="n">3,383</div><div class="l">수요기관</div></div>
  <div class="card"><div class="n">35</div><div class="l">개월 연속</div></div>
  <div class="card"><div class="n">10·16</div><div class="l">산업·유형 범주</div></div>
</div>

![w:540](figures/02_count_by_month.png)

<span class="small">추정가격 <b>평균 5.85억 · 중앙 1.22억</b> (4.8배 우편향 → 회귀 시 log1p) · 2023-01~2025-11</span>
...
- 행정·공공 = **유지보수 압도** / 교육·연구 = **구축 비중↑**
- 카이제곱 **χ²=2,824, p≈0** → 산업과 유형은 통계적으로 유의하게 연관

> 동료 지적("기타 많아 교차 안 됨")을 **기타 0% + 검정**으로 해소
...
> 공공 IT 지출의 **절반 이상이 유지보수·운영·고도화** — 신규 구축은 18%에 불과
...
<div class="cards">
  ...
  <div class="card"><div class="n">1.27억</div><div class="l">non-ai 중앙 예산</div></div>
  <div class="card"><div class="n">p&lt;10⁻¹¹</div><div class="l">Welch t = -6.91</div></div>
</div>

> AI 공고는 **비중도 작고(9%) 건당 예산도 더 작다** — 아직 **소규모 PoC·실증** 단계

<span class="small">담론은 AI를 미래로 말하지만, 실제 조달은 '운영·유지보수'에 예산이 몰림</span>
