...
🔗 <b>흐름 연결</b> : 7번 <b>"무엇을 발주하나"</b>(산업별 키워드) → 11번 <b>"어떤 유형을 원하나"</b>(산업×유형) → <b>15번 "어떻게 수주하나"</b> — 앞 분석이 그대로 이 서비스의 입력
</div>

- 신규 공고 → 분류 엔진(산업·유형·AI) → **산업 니즈 패턴 + 과거 제안서 목차**로 어필 포인트 도출
- Claude가 **목차·핵심 메시지·차별화 전략**이 담긴 **가안 제안서 초안** 생성 (제안서 1건 **수일→수분**)

<span class="small">※ 현재 7번은 키워드 빈도 수준 → 핵심 포인트 직접 추출·담당자 매칭 실구현은 향후 (본 발표는 구성·샘플)</span>
