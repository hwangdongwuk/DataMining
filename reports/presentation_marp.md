...
| 교수 Q3 | H3를 t-test로 검증? | **p<10⁻²⁰ 지지** (p.9) |
| 동료 다수 | "기타 많아 교차 안 됨" | 산업×컨설팅 **카이제곱 유의** (p.12) |
...
# 7. 발주 규모 & 트렌드 — 건수는 정체, 금액·AI는 성장

<span class="small">전체 <b>33,860건</b> · 3,383 기관 · 35개월 · 연도별 추세 ↓</span>

| 연도 | 발주 건수 | 총 발주액 | 중앙 예산 | AI 비중 |
|---|--:|--:|--:|--:|
| 2023 | 11,939 | 5.8조 | 1.21억 | 6.1% |
| 2024 | 11,251 | 6.6조 | 1.22억 | 8.0% |
| 2025* | 10,670 | **7.4조** | 1.23억 | **13.4%** |

<span class="small">*2025는 1~11월 집계 · 총 발주액 = 추정가격 합계</span>

<div class="insight" style="font-size:20px;">
📉 건수는 <b>정체·소폭 감소</b> &nbsp;|&nbsp; 💰 총 발주액 <b>5.8→7.4조 (+27%)</b> &nbsp;|&nbsp; 🤖 AI 비중 <b>2배↑(6→13%)</b><br>
→ 공공 IT는 '양적 확대'를 끝내고 <b>건당 대형화 + AI 전환</b>기 · 정부 AI 도입 가속은 국내외 공통 트렌드
</div>

---

# 8. 산업 × IT 발주 내용 — 무엇을 발주하나

<span class="small"><b>33,860건</b> · 공고명 키워드로 추출한 산업별 주력 IT 사업</span>

| 산업 | 비중 | AI% | 주요 발주 IT 내용 (키워드) |
|---|--:|--:|---|
| 행정·공공 | 41.5% | 6.9% | 주정차단속·행정정보통신·민방위·자동음성통보 |
| 교육·연구 | 18.7% | 14.4% | MOOC·산학협력·대학혁신지원·디지털헬스케어 |
| 농림·수산·환경 | 9.3% | 5.4% | 물·농업용수 **자동화**·재해예방계측·기후예측·해양관제(VTS) |
| 국토·교통·건설 | 7.5% | 4.9% | 스마트시티·지하철·교통단속·시설(화재)안전 |
| 산업·에너지 | 5.5% | 12.4% | 데이터바우처·수출플랫폼·공개SW·원전 |
| 문화·관광·체육 | 5.1% | 5.9% | 문화데이터·**말뭉치**·통합문화정보·도서관 |
| 의료·보건 | 5.0% | 10.5% | 통합의료정보·진료정보교류·예방접종관리·코호트 |
| 정보·통신 | 4.4% | **22.3%** | 지방재정·주민등록·주소정보·보안·**AI(AX)** |
| 금융 | 2.1% | 3.0% | **지급결제플랫폼**·신용보증·무역보험 |
| 보험 | 0.9% | 6.0% | 실손보험 전산화·개인정보영향평가·종합정보시스템 |

> 산업마다 발주 IT가 뚜렷이 다름 — 농림은 **자동화/계측**, 문화는 **데이터/말뭉치**, 금융은 **결제플랫폼**, 정보통신은 **AI·보안**에 집중

<span class="small">🔗 이 <b>산업별 니즈 패턴</b>이 Q③ Win Strategy 자동추출(p.15)의 <b>입력 데이터</b> — "산업을 알면 어떤 사업을 원하는지 예측"</span>

<span class="small">📌 <b>말뭉치</b> = AI 언어모델 학습용 한국어 텍스트 데이터셋 (예: 국립국어원 '한국어 말뭉치 구축' 사업) — 문화 산업의 대표 AI 발주</span>

---

# 9. 가설 검정 — 무엇을, 어떻게 확인했나
...
<div class="insight" style="font-size:19px;padding:14px 20px;">
🔗 <b>흐름 연결</b> : 8번 <b>"무엇을 발주하나"</b>(산업별 키워드) → 12번 <b>"어떤 유형을 원하나"</b>(산업×유형) → <b>15번 "어떻게 수주하나"</b> — 앞 분석이 그대로 이 서비스의 입력
</div>

- 신규 공고 → 분류 엔진(산업·유형·AI) → **산업 니즈 패턴 + 과거 제안서 목차**로 어필 포인트 도출
- Claude가 **목차·핵심 메시지·차별화 전략**이 담긴 **가안 제안서 초안** 생성 (제안서 1건 **수일→수분**)

<span class="small">※ 현재 8번은 키워드 빈도 수준 → 핵심 포인트 직접 추출·담당자 매칭 실구현은 향후 (본 발표는 구성·샘플)</span>
...
<h2 style="color:#065f46;margin:4px 0;">✅ 세 가지 질문에 답했다</h2>

| 연구 질문 | 답 (한 줄) |
|---|---|
| ① Pain Point를 숫자로? | **됐다** — 기타 88.5%→0%, 산업별 발주 패턴 정량화 |
| ② 컨설팅 수요와 연결? | **됐다** — 산업마다 원하는 사업 다름(교차분석으로 확인) |
| ③ Win Strategy 자동 추출? | **방향 제시** — 제안서 자동생성 서비스로 구현(초안) |

<span class="small">📈 +트렌드: 발주 <b>건수는 정체</b>지만 <b>금액 +27%·AI 2배↑</b> — 공공 IT가 'AI 전환'기로</span>

<div class="two" style="margin-top:10px;">
  <div class="col before"><h3>⚠️ 솔직한 한계</h3>
    <ul style="font-size:16px;">
      <li>산업 구분을 '발주 <b>기관 성격</b>'으로 함 → 공고 <b>내용 자체</b>로 본 건 아님</li>
      <li>공고 첨부문서는 <b>173건만</b> 분석 (전체 아님)</li>
      <li>금융 규제 데이터 <b>30건뿐</b> → 규제→발주 시차 분석엔 부족</li>
    </ul>
  </div>
  <div class="col after"><h3>🚀 다음 단계</h3>
    <ul style="font-size:16px;">
      <li>첨부 PDF <b>전부 읽어</b> 본문까지 분석(토픽모델링)</li>
      <li>규제가 <b>실제 발주로 이어지는지</b> 시간차 분석</li>
      <li>제안서 자동생성 <b>품질 평가셋</b> 구축</li>
    </ul>
  </div>
</div>
